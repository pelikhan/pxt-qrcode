  ...
  export class QRUtil {
    ...
    public static getMaxLength(
      ...
      switch (errorCorrectLevel) {
        ...
        default:
          qrcode.panic('e:' + errorCorrectLevel);
      }
    ...
    public static getMaskFunc(
      ...
      switch (maskPattern) {
        ...
        default:
          return qrcode.panic('mask:' + maskPattern);
      }
    }
